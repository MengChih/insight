 ...
 * Class PostLayoutTwo
 */
class HashmagMikadoPostLayoutTwo extends HashmagMikadoWidget
{
    /**
    ...
    public function __construct() {
        parent::__construct(
            'mkdf_post_layout_two_widget', // Base ID
    ...
    public function widget($args, $instance) {
        ...
        $instance['thumb_image_width'] = $instance['thumb_image_width'] != '' ? $instance['thumb_image_width'] : '120';
        $instance['thumb_image_height'] = $instance['thumb_image_height'] != '' ? $instance['thumb_image_height'] : '120';
        ...
        echo '<div class="widget mkdf-plw-two">';
