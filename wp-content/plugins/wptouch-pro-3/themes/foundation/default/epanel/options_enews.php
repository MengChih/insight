...
//-------------------------------------------------------------------------------------//
	...
	array( "name" => "wrap-layout",
		...
		array( "name" => "layout-1",
			...
			array( "name" => "Enable Share This button",
                   "id" => $shortname."_posts_share",
                   "type" => "checkbox",
                   "std" => "on",
                   "desc" => "By default the theme places a Share This button on the top of all posts with a list of social bookmarking sites that visitors can use to promote your blog. If you don't want this button to appear simply disable this option. "),
		...
		array( "name" => "layout-3",
			...
			array( "name" => "Shorten older posts",
            "id" => $shortname."_home_shorten_posts",
            "type" => "checkbox",
            "std" => "on",
			"desc" => "By default the homepage displays a set of large post preview and a set of short ones, the older posts being the shorter. This is to save space and to give your most recent mosts more prominence. If you would rather display all posts in the large format, however, simply disable this option."),
...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		ul#page-menu li a, ul#page-menu li li a, ul#page-menu li.current_page_item li a, ul#page-menu li.current_page_parent li.current_page_item a { color: #<?php echo(get_option($shortname.'_color_pagelink')); ?>; }
		ul#cats-menu li a { color: #<?php echo(get_option($shortname.'_color_catslink')); ?>; }
		.pics div h1 a { color: #<?php echo(get_option($shortname.'_color_featheader')); ?>; }
		.mainpost-wrap h2 a, .new-post h2 a { color:#<?php echo(get_option($shortname.'_color_recentheadings')); ?>; }
		#sidebar h3 { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		#footer-widgets-inside h4 { color:#<?php echo(get_option($shortname.'_color_footer_titles')); ?>; }
		.sidebar-block a, #footer-widgets-inside div.widget a { color:#<?php echo(get_option($shortname.'_color_footer_links')); ?>; }
		div.breadcrumb { color:#<?php echo(get_option($shortname.'_color_breadcrumb')); ?>; }
		h1.post-title { color:#<?php echo(get_option($shortname.'_color_heading')); ?>; }
	</style>
