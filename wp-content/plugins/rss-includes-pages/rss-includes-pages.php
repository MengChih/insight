...
<div class="wrap" style="padding-bottom: 5em;">
	...
	<p>By default posts and pages are set to be included in feeds. The <a href="http://infolific.com/technology/software-worth-using/include-pages-in-wordpress-rss-feeds/#pro-version" target="_blank">pro version</a> (just $5) allows you to change these options as well as add custom post types to your feed.</p>
	<div id="rssip-items">
	...
	<div id="rssip-sb">
		<div class="postbox" id="rssip-sbone">
			...
			<div class="inside">
				...
				<p>This plugin allows you to include pages in your RSS feed. The <a href="http://infolific.com/technology/software-worth-using/include-pages-in-wordpress-rss-feeds/#pro-version" target="_blank">pro version</a> (just $5) gives you a little more control.</p>
				<ol>
